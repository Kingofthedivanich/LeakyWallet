...
Этап 7 — парсер на правилах (каталог сервисов, регулярки на сумму/валюту/
дату/период, дедуп по message_id, самокоррекция периодичности). Полностью
покрыт тестами на синтетических фикстурах — живого теста не требует.
Стадии 5–6 (OAuth и скан почты) по-прежнему ждут вашей проверки на
реальном Google-аккаунте — см. ниже.
